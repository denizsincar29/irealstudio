...
## Adding custom instructions for copilot coding agent (for yourself to work on this repo)
...
Prompt the agent to install uv package manager for python and to use it for installing any dependencies and running commands, as it is faster and more reliable than pip.
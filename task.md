# task
Please implement the following features in the app. Please focus more on metronome delay fix and chord voicings, but don't forget about the rest of the tasks as well. If you have any questions, please ask me.
...
## Packaging
Don't know if nuitka supports, but the folder with the app should have all translations and needed resources to ship, and the workflow must zip a folder. Alternatively, if translations are already in the exe, the asset must be the exe.
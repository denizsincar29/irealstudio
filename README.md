...
- **Alt** открывает нативное меню: **Файл** (Новая цифровка Ctrl+N / Открыть Ctrl+O /
  Сохранить Ctrl+S / Сохранить как / Выход), **Песня** (Озвучить такт F5 /
  Озвучить всю цифровку F6 / В начало / В конец), **Справка** (О программе).
  NVDA читает пункты и их help.

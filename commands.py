...
_CMD_FILE_QUIT      = 1006
_CMD_FILE_NEW       = 1007
_CMD_FILE_OPEN_TEMPLATE   = 1008  # "Browse for template…"
_CMD_FILE_SAVE_TEMPLATE   = 1009  # "Save as template…"
_TEMPLATE_BASE            = 1200  # IDs 1200..1299 → template-file indices 0..99
...
_CMD_CHORD_PLAY_OFF     = 3010  # chord playback: off
_CMD_CHORD_PLAY_NAV     = 3011  # chord playback: during navigation
_CMD_CHORD_PLAY_PB      = 3012  # chord playback: during playback
_CMD_CHORD_PLAY_BOTH    = 3013  # chord playback: both
